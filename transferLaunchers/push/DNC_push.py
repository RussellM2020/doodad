...
mode_ec2 = dd.mode.EC2AutoconfigDocker(
        ...
        s3_log_name='DNC_CONTINUE'+regionSize+ '_block_mass0.01_posPlace',
...
numPartitions = 10
step_size = 0.01 ; penalty = 0.05 ; seed = 0

init_param_file = '/root/code/dnc/trainedPolicies/Push/best.pkl'
...
dd.launch_python(
    target=os.path.join(THIS_FILE_DIR, '/home/russellm/dnc/examples/dnc_push.py'),
    ...
    args={
        'variant': {'numPartitions': numPartitions, 'hidden_sizes': hidden_sizes, 'batch_size': batch_size , 'step_size': step_size, 
                    'saveDir': OUTPUT_DIR+expName+'/', 'penalty': penalty, 'regionSize' : regionSize, 'init_param_file': init_param_file},
