...
mode_ec2 = dd.mode.EC2AutoconfigDocker(
        ...
        spot_price=0.5,  # Maximum bid price
        s3_log_prefix='Sawyer_Push',  # Folder to store log files under
        s3_log_name='ppoExperts_60X30',
...
targetScript = '/home/russellm/baselines/baselines/ppo2/ppo_sawyer_push.py'
...
for index in range(20):
    ...
    pythonCommand = str(targetScript)+' --contextual '+str(contextual) + ' --index '+str(index)
