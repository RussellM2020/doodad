...
mode_ec2 = dd.mode.EC2AutoconfigDocker(
        ...
        s3_log_name='ppoContextual_60X30_block_mass0.01_origRew',
...
contextual = True ; enableRotation = False ; objType = 'block' ; rewMode = 'orig'
#seed = 0 ; hidden_sizes = [150, 100, 50] ; batch_size = 2048 ; startTask = 0
cliprange = 0.03 ; batch_size = 2048 ; startTask = 0 ; numTasks = 20
        ...
        dd.launch_python(
            ...
            args={
                'variant': {'tfSeed': tfSeed, 'npSeed' : npSeed,  'batch_size': batch_size , 'contextual' : contextual , 'enableRotation' : enableRotation, 'objType' : objType, 
                            'rewMode': rewMode , 'hiddenSizes' : hidden_sizes, 'startTask': startTask, 'numTasks':numTasks, 'expName' : expName, 'cliprange': cliprange},
