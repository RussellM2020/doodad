...
mode_ec2 = dd.mode.EC2AutoconfigDocker(
        ...
        s3_log_name='noGoalInfo_finnMAML_'+regionSize,
...
for seed in range(2):
    for fbs in [20, 50]:
        for flr in [0.05, 0.1, 0.5]:
            ...
            dd.launch_python(
                target=os.path.join(THIS_FILE_DIR, '/home/russellm/maml_rl/maml_examples/maml_sawyer_pickPlace_push_launcher.py'),
                ...
                args={
                    ...
                    'envType': envType,  'n_parallel' : n_parallel},
