...
radius = 2
max_path_length = 200
trainGoals =  pickle.load(open('/home/russellm/iclr18/maml_gps/rllab/envs/mujoco/fullCircle_rad'+str(radius)+'.pkl', "rb"))
        ...
        for fbs in [20, 50]:                
            for flr in [0.05, 0.01]:
                for kl_penalty in [0.05, 0, 0.1]:
                    ...
                    dd.launch_python(
                        target=os.path.join(THIS_FILE_DIR, '/home/russellm/iclr18/maml_gps/maml_examples/maml_gps_ant_launcher.py'),
