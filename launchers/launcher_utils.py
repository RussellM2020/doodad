...
def gen_mode(image, use_gpu , mode = 'docker' , ec2_region = 'us-west-1' , s3 = {}, ssh_host = 'newton4'):
    ...
    if mode == 'docker':
        ...
        return  dd.mode.EC2AutoconfigDocker(
                ...
                spot_price=price,  # Maximum bid price
...
def get_exp_name(exp_name,   mode = 'docker' , log_dict={'log_prefix': '' , 'log_name': ''} ):

    if mode !='ec2':
        return log_dict['log_prefix']+'/'+log_dict['log_name']+'/'+exp_name
    else:
        return exp_name
